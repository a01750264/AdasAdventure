...
public class Meta : MonoBehaviour
{
    ...
    public IEnumerator CrearPartidaPuntos()
    {
        ...
        UnityWebRequest request = UnityWebRequest.Post("http://3.141.197.134:8080/partida/agregarPartida", forma);  // Se manda la petición POST al servidor con los datos anteriores
